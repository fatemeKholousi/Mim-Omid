...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/styles/css-circular-prog-bar.css" type="text/css">
...
<body>
  ...
  <a href="<?php echo base_url() ?>index.php/login"><button>login</button></a>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url() ?>index.php/welcome/contact_me"> ارتباط ما </a>
                </li>

                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url() ?>index.php/welcome/about_me"> درباره ما </a>
                </li>

                <li class="nav-item">
                  <a class="nav-link" href="<?php echo base_url() ?>index.php/welcome/register"><button>ثبت نام</button></a>
                </li>


                <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url() ?>index.php/login"><button> ورود</button></a>
                </li>

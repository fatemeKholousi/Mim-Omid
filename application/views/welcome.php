...
<body class="welcome-page">
	...
	<header class="welcome-page--header">
		...
		م.امید
			...
			<img src="<?php echo base_url(); ?>assets/images/top-img.jpg" width="40%" height="400px" class="header-image" />
	...
	<section class="books">
		<h1>آثار</h1>
		<img src="<?php echo base_url(); ?>assets/images/asar.png" width="60%" class="header-image" />
